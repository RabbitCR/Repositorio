...
/*	 public ListaEnlazada(ListaDoblementeEnlazada lista)
    ...
    public ListaEnlazada obtenerElementoEnPosicion(int posicion) 
	{
        ...
        result.agregar(nodoActual.obtenerDato1(), nodoActual.obtenerDato2(), nodoActual.obtenerDato3(), nodoActual.obtenerDato4(), nodoActual.obtenerDato5(), nodoActual.obtenerDato6());
        //result.toString();
        return result;
    }
    public Object obtenerDato1 (){
        return this.primerNodo.obtenerDato1();
    }
    
    public Object obtenerDato2 (){
        return this.primerNodo.obtenerDato2();
    }
    
    public Object obtenerDato3 (){;
        return this.primerNodo.obtenerDato3();
    }
    
    public Object obtenerDato4 (){
        return this.primerNodo.obtenerDato4();
    }
    
    public Object obtenerDato5 (){
        //System.out.println(this.primerNodo.obtenerDato5());
        return this.primerNodo.obtenerDato5();
    }
    
    public Object obtenerDato6 (){
        return this.primerNodo.obtenerDato6();
    }
