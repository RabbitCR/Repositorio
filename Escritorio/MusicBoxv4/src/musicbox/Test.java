...
public class Test {
    public static void main(String[] args)throws Exception{
        ...
        Files.getAllMetaData("/media/andres/Datos/Music/(+44)/When Your Heart Stops Beating/");
        //Files.getMetaData("/home/andres/NetBeansProjects/MusicBox/src/Make You Smile.mp3");
    }
}
